...
| CON-02 | [并发学习进度与首次完课](./docs/02-concurrent-learning-progress.md) | `POST /api/v1/learning-behaviors` | 原子累加 + `complete_time IS NULL` | 丢失更新、CAS、状态机、首次事件 | 已实测，发现进度偏差，待修复复测 |
