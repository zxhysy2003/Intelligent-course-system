...
CREATE TABLE `agent_message`  (
  ...
  `metadata_json` json NULL COMMENT '模型、来源、耗时等元数据',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_agent_message_session_time`(`session_id` ASC, `user_id` ASC, `create_time` ASC, `id` ASC) USING BTREE,
  INDEX `idx_agent_message_user_time`(`user_id` ASC, `create_time` ASC, `id` ASC) USING BTREE,
  CONSTRAINT `chk_agent_message_role` CHECK (`role` in (_utf8mb4'USER',_utf8mb4'ASSISTANT'))
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '学习助手消息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `agent_session`  (
  ...
  `user_id` bigint NOT NULL COMMENT '用户ID',
  `title` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '会话标题',
  `status` tinyint NOT NULL DEFAULT 1 COMMENT '状态：1-正常 0-删除',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_agent_session_user_time`(`user_id` ASC, `status` ASC, `update_time` ASC, `id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '学习助手会话表' ROW_FORMAT = Dynamic;
...
INSERT INTO `course` VALUES (14, 'test2', '测试使用。。。', 'https://www.economist.com/cdn-cgi/image/width=1424,quality=80,format=auto/content-assets/images/20260228_LDP001.jpg', 1, 705, 1, '2026-02-27 14:45:07', '2026-05-10 13:59:40', '2026-05-10 13:58:46');
...
CREATE TABLE `course_hot_score`  (
  ...
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '同步时间',
  PRIMARY KEY (`course_id`) USING BTREE,
  INDEX `idx_hot_score`(`hot_score` ASC, `course_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '课程热度快照表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `recommend_user_course_score`  (
  ...
  `last_behavior_time` datetime NULL DEFAULT NULL COMMENT '最近一次学习/完成行为时间',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '推荐用户课程评分快照表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of recommend_user_course_score
-- ----------------------------
INSERT INTO `recommend_user_course_score` VALUES (2, 1, 14.517470882163373, 5.160983251830564, '2026-04-03 21:10:00', '2026-05-17 15:52:44');
INSERT INTO `recommend_user_course_score` VALUES (2, 3, 10.988594021634027, 4.227210619250771, '2026-04-02 22:15:00', '2026-05-17 15:52:44');
INSERT INTO `recommend_user_course_score` VALUES (2, 4, 9.0771543623622, 3.6482689955897496, '2026-03-30 23:00:00', '2026-05-17 15:52:44');
INSERT INTO `recommend_user_course_score` VALUES (3, 1, 6.781176968073264, 2.875594781318881, '2026-04-01 18:05:00', '2026-05-17 15:52:44');
INSERT INTO `recommend_user_course_score` VALUES (3, 6, 10.672823778674369, 4.135343550172232, '2026-04-04 09:20:00', '2026-05-17 15:52:44');
INSERT INTO `recommend_user_course_score` VALUES (3, 7, 4, 1.8126924692201818, NULL, '2026-05-17 15:52:44');
INSERT INTO `recommend_user_course_score` VALUES (4, 5, 11.476739100628285, 4.366402994009836, '2026-04-02 08:30:00', '2026-05-17 15:52:44');
INSERT INTO `recommend_user_course_score` VALUES (4, 8, 17.807307427487835, 5.894942616972778, '2026-03-28 21:40:00', '2026-05-17 15:52:44');
INSERT INTO `recommend_user_course_score` VALUES (4, 9, 15.407307427487837, 5.371560725084137, '2026-03-31 20:10:00', '2026-05-17 15:52:44');
INSERT INTO `recommend_user_course_score` VALUES (5, 11, 5.590659700031606, 2.438632137692671, '2026-04-03 14:00:00', '2026-05-17 15:52:44');
INSERT INTO `recommend_user_course_score` VALUES (5, 12, 1, 0.48770575499285984, NULL, '2026-05-17 15:52:44');
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户兴趣标签表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `user_interest_tag` VALUES (4, 4, 7, 1, 'INIT', '2026-05-07 14:31:48', '2026-05-07 14:31:48');
INSERT INTO `user_interest_tag` VALUES (5, 4, 1, 1, 'INIT', '2026-05-07 14:31:48', '2026-05-07 14:31:48');
INSERT INTO `user_interest_tag` VALUES (6, 4, 14, 1, 'INIT', '2026-05-07 14:31:48', '2026-05-07 14:31:48');
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户冷启动初始化画像表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `user_onboarding_profile` VALUES (2, 4, 2, 'FOUNDATION', 1, '2026-05-07 14:31:49', '2026-05-07 14:31:49');
